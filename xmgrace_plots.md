...
You can [download](media/images/python/xmgrace_tutorial_Numeric.py) the full source code. 
To run the source code at the command line, type: `python xmgrace_tutorial_Numeric.py`
...
![](media/images/xmgrace_plot_all.jpg)
...
![](media/images/xmgrace_plot_g0s0.jpg)
...
![](media/images/xmgrace_plot_g0s1.jpg)
...
![](media/images/xmgrace_plot_g1s0.jpg)
...
![](media/images/xmgrace_plot_zeros.jpg)  
